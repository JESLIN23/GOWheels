        ...
        <Grid container className={styles.container}>
          <Grid item xs={12} sm={6} className={styles.workContent} >
            ...
            <div>
              ...
              <p style={{marginTop: 15}}>Use our website or apps to search & book a vehicle that suits your budget & needs</p>
            </div>
          </Grid>
          <Grid item xs={12} sm={6} className={styles.workContent} >
            <div className={styles.worklogo}>
            ...
            <div>
              ...
              <p style={{marginTop: 15}}>Ride from home or from any of our conveniently located sites around your city</p>
            </div>
          </Grid>
          <Grid item xs={12} sm={6} className={styles.workContent} >
            <div className={styles.worklogo}>
          ...
          <Grid item xs={12} sm={6} className={styles.workContent} >
            ...
            <div>
              ...
              <p style={{marginTop: 15}}>Get the vehicle back to your preferred return location, and we will take it from there</p>
            </div>
          </Grid>
        </Grid>
      </div>
